...
class FirstFragment : Fragment() {
    ...
    private var firstFragmentViewModel = FirstFragmentViewModel()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        firstFragmentViewModel.cityCode = City(16)
        firstFragmentViewModel.cityName = City("Bursa")
        clickActions()
    }

    private fun clickActions() {
        lifecycleScope.launchWhenStarted {
            firstFragmentViewModel.cityCodeClickAction.collect() {
                Toast.makeText(requireContext(), "City Code: $firstFragmentViewModel.cityName", Toast.LENGTH_SHORT)
            }
            firstFragmentViewModel.cityNameClickAction.collect() {
                Toast.makeText(requireContext(), "City Name: $firstFragmentViewModel.cityCode", Toast.LENGTH_SHORT)
            }
        }
    }
